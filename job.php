...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = $connection->query("SELECT * FROM jobs WHERE id = '$id'");
    $result->execute();
    $job = $result->fetch(PDO::FETCH_OBJ);
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="custom-breadcrumbs">
                        ...
                        <span class="text-white"><strong><?php echo $job->job_title ?></strong></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-8 mb-4 mb-lg-0">
                    <div class="d-flex align-items-center">
                        <div class="border p-2 d-inline-block mr-3 rounded">
                            <img width="150px" src="<?php echo BASE_URL .'/'. $job->company_image ?>" alt="Image">
                        </div>
                        <div>
                            <h2><?php echo $job->job_title ?></h2>
                            <div>
                                <span class="ml-0 mr-2 mb-2"><span class="icon-briefcase mr-2"></span><?php echo $job->company_name ?></span>
                                <span class="m-2"><span class="icon-room mr-2"></span><?php echo $job->job_region ?></span>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="mb-5">
                            <figure class="mb-5"><img src="public/images/job_single_img_1.jpg" alt="Image" class="img-fluid rounded"></figure>
                    ...
                    <div class="col-lg-4">
                        <div class="bg-light p-3 border rounded mb-4">
                            ...
                            <ul class="list-unstyled pl-3 mb-0">
                                <li class="mb-2"><strong class="text-black">Published on:</strong> <?php echo $job->application_deadline ?></li>
            ...
            <ul class="job-listings mb-5">
                <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                    ...
                    <div class="job-listing-logo">
                        <img src="public/images/job_logo_1.jpg" alt="Image" class="img-fluid">
                    </div>
                ...
                <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                    <a href="job-single.html"></a>
                    <div class="job-listing-logo">
                        <img src="public/images/job_logo_2.jpg" alt="Image" class="img-fluid">
                    </div>
                ...
                <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                    <a href="job-single.html"></a>
                    <div class="job-listing-logo">
                        <img src="public/images/job_logo_3.jpg" alt="Image" class="img-fluid">
                    </div>
                ...
                <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                    <a href="job-single.html"></a>
                    <div class="job-listing-logo">
                        <img src="public/images/job_logo_4.jpg" alt="Image" class="img-fluid">
                    </div>
                ...
                <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                    <a href="job-single.html"></a>
                    <div class="job-listing-logo">
                        <img src="public/images/job_logo_5.jpg" alt="Image" class="img-fluid">
                    </div>
